                    ...
                    <div class="col-md-5">
                        <div class="card form-card-narrow bg-white">
                            <div class="card-header bg-white py-3">
                                <span class="fw-bold text-slate-800"><i class="bi bi-shield-lock-fill me-2 text-primary"></i>Đổi mật khẩu</span>
                            </div>
                            <div class="card-body p-4">
                                <% 
                                    ...
                                    if (error != null) {
                                %>
                                    <div class="alert alert-danger py-2 border-0 bg-light text-danger" style="font-size: 0.9rem;">
                                ...
                                <% 
                                    if (message != null) {
                                %>
                                    <div class="alert alert-success py-2 border-0 bg-light text-success" style="font-size: 0.9rem;">
                                ...
                                <form action="change-password" method="POST">
                                    ...
                                    <div class="form-actions">
                                        <a href="profile.jsp" class="btn btn-outline-secondary">Hủy</a>
