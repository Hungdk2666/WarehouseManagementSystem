                    ...
                    <div class="card shadow-sm border-0 bg-white mt-4 mb-4">
                        <div class="card-header bg-primary bg-opacity-10 py-3 border-0 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold text-slate-800">
                                <i class="bi bi-upc-scan me-2 text-primary"></i>In-Stock Serial Numbers & Barcodes
                            </h5>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center py-5 text-muted">
                                ...
                                No physical items currently in stock for this product.
                            </div>
                            <% } else { %>
                                ...
                                <table class="table table-hover align-middle mb-0">
                                    <thead class="table-light sticky-top">
                                        <tr>
                                            ...
                                            <th style="width: 40%;">Barcode Label</th>
                                            <th style="width: 20%;">Date Imported</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <% 
