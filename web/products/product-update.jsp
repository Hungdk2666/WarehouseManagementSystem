        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="page-title">Cập nhật thông tin sản phẩm</h2>
                        <p class="page-subtitle">Chỉnh sửa thông tin chi tiết hoặc thông số kỹ thuật cho <%= product.getProductName() %></p>
                    </div>
                ...
                <div class="card form-card p-4">
                    <form action="product?action=update" method="POST" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="minStock" name="min_stock" min="1" value="<%= product.getMinStock() %>" onkeydown="if(!/^[0-9]$/.test(event.key) && !['Backspace', 'Delete', 'ArrowLeft', 'ArrowRight', 'Tab', 'Enter', 'Escape'].includes(event.key) && !event.ctrlKey && !event.metaKey) event.preventDefault();" required>
                        </div>
