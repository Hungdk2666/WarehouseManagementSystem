...
<%
    ...
    if (loggedInUser == null || !loggedInUser.hasPermission("DESTINATION_VIEW")) {
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (clearBtn && searchInput) {
                clearBtn.addEventListener("click", function() {
                    ...
                    document.getElementById("destinationTable").dispatchEvent(event);
                });
            }
        });
        ...
        function initPagination(tableId, containerId, selectId, searchInputId) {
            ...
            document.getElementById("destinationTable").addEventListener("filterReset", () => {
                currentPage = 1;
                updateTable();
            });
