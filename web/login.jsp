...
<body class="auth-body">
    <div class="auth-container animated-fade-in">
        ...
        <div class="auth-card">
            <h3 class="text-center mb-4 card-title">Đăng nhập</h3>
            ...
            <form action="login" method="POST">
                <div class="mb-3">
                    <label class="form-label"><i class="bi bi-person-fill me-1"></i> Tên đăng nhập</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="Nhập mật khẩu" required autocomplete="current-password">
                </div>
                <div class="d-grid mb-3 mt-4">
                    <button type="submit" class="btn btn-primary btn-lg fs-6"><i class="bi bi-box-arrow-in-right me-1"></i> Đăng nhập</button>
                </div>
                <div class="text-center mt-3">
                    <a href="forgot-password" class="text-decoration-none small"><i class="bi bi-question-circle me-1"></i>Quên mật khẩu?</a>
                </div>
            </form>
        </div>
    </div>
