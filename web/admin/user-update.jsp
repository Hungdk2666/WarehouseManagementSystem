                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm border-0 bg-white">
                            <div class="card-header bg-warning bg-opacity-10 py-3 border-0">
                                <h4 class="mb-0 fw-bold text-warning-emphasis"><i class="bi bi-pencil-square me-2"></i>Update User Info</h4>
                            </div>
                            <div class="card-body p-4">
                                <form action="user?action=update" method="POST">
                                    <input type="hidden" name="id" value="<%= userInfo.getId() %>">
                                    <div class="mb-3">
                                        <label class="form-label"><i class="bi bi-person me-1 text-muted"></i> Username (Read-only)</label>
                                    ...
                                    <div class="d-grid mb-3 mt-4">
                                        <button type="submit" class="btn btn-warning fw-semibold"><i class="bi bi-check-circle me-1"></i> Update Info</button>
                                    </div>
