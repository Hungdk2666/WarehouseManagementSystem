                    ...
                    <div class="col-md-6">
                        <div class="card form-card">
                            <div class="card-header bg-white py-3">
                                <h4 class="mb-0 fw-bold text-slate-800"><i class="bi bi-pencil-square me-2 text-primary"></i>Cập nhật thông tin người dùng</h4>
                            </div>
                            <div class="card-body p-4">
                                <form action="user?action=update" method="POST">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i>Cập nhật thông tin</button>
                                    </div>
                                </form>
                            </div>
                        </div>
