        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h2 class="fw-bold text-slate-800 mb-1">Danh sách danh mục</h2>
                        <p class="text-muted small mb-0">Phân loại sản phẩm trong kho lưu trữ vật lý của bạn</p>
                    </div>
                        ...
                        <div class="row g-2 align-items-center">
                            <div class="col-md-9 col-lg-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="categorySearchInput" class="form-control border-start-0 ps-0 shadow-none" placeholder="Tìm kiếm theo tên, mô tả...">
                                </div>
                            </div>
                ...
                <div class="card shadow-sm border-0 bg-white mb-4">
                    <div class="card-header bg-primary bg-opacity-10 py-3 border-0 d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold text-primary"><i class="bi bi-tags-fill me-2"></i>Quản lý danh mục</h5>
                        <% if (canAdd) { %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-center gap-1">
                                                 <% if (canEdit) { %>
                                                 <a href="category?action=update&id=<%= c.getId() %>" class="btn btn-sm btn-warning d-inline-flex align-items-center gap-1 py-1 px-2.5" title="Chỉnh sửa">
                                                ...
                                                <form action="category?action=toggle" method="POST" class="d-inline m-0">
                                                    ...
                                                    <button type="submit" class="btn btn-sm <%= c.isStatus() ? "btn-outline-danger" : "btn-primary" %> d-inline-flex align-items-center gap-1 py-1 px-2.5" title="<%= c.isStatus() ? "Vô hiệu hóa danh mục" : "Kích hoạt danh mục" %>">
                                    ...
                                    <tr>
                                        <td colspan="<%= canManage ? 5 : 4 %>" class="text-center text-muted py-5">
                                            ...
                                            Không có danh mục nào được đăng ký trong cơ sở dữ liệu.
                                        </td>
                                    </tr>
                                    <% } %>
                                </tbody>
