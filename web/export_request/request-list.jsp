...
<%
    ...
    List<ExportRequest> requestList = (List<ExportRequest>) request.getAttribute("requestList");
    boolean canAdd = loggedInUser.hasPermission("EXPORT_REQ_ADD");
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Export Requests - WMS</title>
        <!-- Google Fonts - Inter -->
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-lg-10">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div>
                            <h2 class="fw-bold text-slate-800 mb-1">Export Requests</h2>
                            <p class="text-muted small mb-0">Manage and track internal warehouse outbound orders.</p>
                        </div>
                        <% if (canAdd) { %>
                        ...
                        <div class="card-body p-3">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="searchInput" class="form-control form-control-sm shadow-sm rounded-3" placeholder="Enter request code..." style="box-shadow: none; font-size: 0.85rem;">
                                </div>
                                <!-- Date Filter -->
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="creatorFilter" class="form-control form-control-sm shadow-sm rounded-3" placeholder="Type name..." style="box-shadow: none; font-size: 0.85rem;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm border-0 bg-white">
                        <div class="card-header bg-primary bg-opacity-10 py-3 border-0 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold text-primary"><i class="bi bi-list-task me-2"></i>Export Requests Registry</h5>
                                    ...
                                    <tbody>
                                        <%
                                            if (requestList != null && !requestList.isEmpty()) {
                                                for (ExportRequest r : requestList) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-start ps-3 fw-semibold"><%= r.getDestinationName() %></td>
                                            <td><span class="badge bg-light text-dark border"><%= r.getExportReason() %></span></td>
            ...
            function initTableFilterAndPagination() {
                ...
                function filterAndPaginate() {
                    ...
                    filteredRows = allRows.filter(row => {
                        ...
                        // Match filters
                        if (searchVal && !code.includes(searchVal))
                            return false;
                        if (dateVal && !createdAt.startsWith(dateVal))
                            return false;
                        if (statusVal && status !== statusVal)
                            return false;
                        if (creatorVal && !creator.includes(creatorVal))
                            return false;
